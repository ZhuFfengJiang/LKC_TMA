...
if __name__ == '__main__':
    input = torch.rand(1, 64, 120, 120).cuda(0)
    lka_layer_exp = deformable_LKA_Attention_experimental(d_model=64).cuda(0)
    lka_layer = deformable_LKA_Attention(d_model=64).cuda(0)
